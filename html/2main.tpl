...
<span><a href="/new">Новинки</a></span><span class="line"></span></div>
<div class="max new">
	<div class="related">
                <ul class="catprods">
	...
	<div class="alllink pad-t-30"><a href="/new">Все Новинки</a></div>
    </div>
{/if}
</div>
...
{if $new_products}
<div class="maintitle mar-b-50 new">
<span><a href="/new" rel="tooltip" title='Все Новинки'>Новинки</a></span><span class="line"></span></div>
<div class="max new">
	<div class="related">
                <ul class="catprods">
               {foreach $new_products as $product name=product}
...
<div class="cat">{get_action_products var=new_products limit=8 visible=1}
{if $new_products}
<div class="maintitle mar-b-50 action">
...
<span><a href="/sale">Скидки</a></span><span class="line"></span></div>
<div class="max sale">
	<div class="related">
                <ul class="catprods">
...
{* <!--Скидки--> *}
<div class="cat" style="margin-top:-20px;">{get_discounted_products var=discounted_products limit=8}
{if $discounted_products}
<div class="maintitle mar-b-50 sale">
<span><a href="/sale" rel="tooltip" title='Все Скидки каталога'>Скидки</a></span><span class="line"></span></div>
<div class="max sale">
	<div class="related">
                <ul class="catprods">
               {foreach $discounted_products as $product}
...
{* <!--Samsung--> 
<div class="catmob">{get_products var=custom_products category_id=60 limit=4}
{if $custom_products}
<div class="maintitle mar-b-50 samsung">
<b></b><span><a href="/catalog/samsung-galaxy" rel="tooltip" title='Смотреть все смартфоны Samsung'>Смартфоны Samsung<span class="i-angle-double-right"></span></a></span><b></b></div>
<div class="max samsung">
	<div class="related">
                <ul class="catprods">
	...
	<div class="alllink pad-t-30"><a href="/catalog/samsung-galaxy">Смотреть все смартфоны Samsung</a></div>
</div>
{/if}</div>


<div class="cat">{get_products var=custom_products category_id=60 limit=5}
{if $custom_products}
<div class="maintitle mar-b-50 samsung">
<b></b><span><a href="/catalog/samsung-galaxy" rel="tooltip" title='Смотреть все смартфоны Samsung'>Смартфоны Samsung<span class="i-angle-double-right"></span></a></span><b></b></div>
<div class="max samsung">
...
<span class="title"><a href="/news" rel="tooltip" title='Все события'>Последние Новости</a></span><span class="line"></span></div>
<div class="max news">
	...
	<div class="alllink pad-t-30"><a href="/news">Все события</a></div>
</div>
{/if}</div>
