...
<div id="slog">
	...
	<form method="post" class="login_form">
		<ul class="export">
			<li>
				<input id="login_email" class="on1" type="text" name="email" required placeholder="Ваш Email" value="{$email|escape}" maxlength="255" />
			</li>
			<li>
				<label>Пароль <a href="/user/password_remind">Забыли?</a></label>
				<input id="login_password" class="on2" type="password" placeholder="введите пароль" required name="password" value="" />
			</li>
			<li>
